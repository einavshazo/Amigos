...
namespace Naot_Limudim_Manage.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,LastName,Phone,Email,SchoolID")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,LastName,Phone,Email,SchoolID")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
